...
Falls man das Programm neu baut, sollte man zuvor seinen eigenen API-Key in der entsprechenden Variablen am Anfang der Program-Klasse eintragen. Dieser kann kostenlos auf finnhub.io beantragt werden.
